function x = batchT1rhoContrast(i,covarFile, BOLDFile, maskFile, prefix, nullModel, model)
...
BOLDTable = table(covars.Subject, covars.Group, covars.Session, covars.Age, covars.Sex, zeros(a,1), 'VariableNames', {'Subject', 'Group', 'Session', 'Age', 'Sex', 'BOLD'});
...
%j=i;
    ...
    for k = 1:zdim
        ...
        if(~isempty(model1))
            ...
            for l = 1:c
                if strcmp(model1.Coefficients{l,1}, 'Group:Session')
