...
DATA_DIR=${SHARE_DIR}/Bipolar_R01
...
if [[ ${T1r10} != "None" && ${T1r50} != "None" ]]
    ...
    bash processT1rho.sh ${FREESURFER_DIR}/sub-${subject}_ses-${session}/SUMA $T1r10 $TSLa $T1r50 $TSLb $OUT_DIR sub-${subject}_ses-${session} $ATLAS_NAME
    else
